...
var myModule = angular.module('app-security-module', []);
myModule.provider('appSecurity', function() {
    var provider = this;
        ...
        for(var level in accessLevelDeclarations){
            ...
            if(typeof accessLevelDeclarations[level] === 'string'){
                if(accessLevelDeclarations[level] === '*'){
                    ...
                    console.log('Error');
                } //"Access Control Error: Could not parse '" + accessLevelDeclarations[level] + "' as access definition for level '" + level + "'")
            }
            else {
